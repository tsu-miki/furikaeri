    ...
    for (const w of Z)
      if (w.type === "childList")
        for (const dl of w.addedNodes)
          dl.tagName === "LINK" && dl.rel === "modulepreload" && S(dl);
...
function Md() {
  ...
  function F(S, Z, w) {
    ...
    return (
      (Z = w.ref),
      { $$typeof: D, type: S, key: dl, ref: Z !== void 0 ? Z : null, props: w }
    );
  }
  return ((me.Fragment = il), (me.jsx = F), (me.jsxs = F), me);
}
var $v;
function Dd() {
  return ($v || (($v = 1), ($c.exports = Md())), $c.exports);
}
var xt = Dd(),
  kc = { exports: {} },
  X = {};
...
var Fv;
function ti() {
  return (Fv || ((Fv = 1), (kc.exports = Ud())), kc.exports);
}
var Rd = ti(),
  Fc = { exports: {} },
  Se = {},
        ...
        function yt(g) {
          for (var O = F(A); O !== null; ) {
            if (O.callback === null) S(A);
              ...
              (S(A), (O.sortIndex = O.expirationTime), il(H, O));
            else break;
            O = F(A);
          }
        }
...
function Yd() {
  ...
  return (D(), (li.exports = qd()), li.exports);
}
/**
 * @license React
...
` +
  ...
  function gi(l) {
    ...
    var u = t.getValue(),
      a = "";
    return (
      l && (a = ri(l) ? (l.checked ? "true" : "false") : l.value),
      (l = a),
  ...
  var Su = {
    ...
    Ui = Ql(Ne),
    Dy = R({}, Ne, { dataTransfer: 0 }),
    Uy = Ql(Dy),
    Ry = R({}, _a, { relatedTarget: 0 }),
    tf = Ql(Ry),
    Hy = R({}, Su, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
    Ny = Ql(Hy),
    qy = R({}, Su, {
  ...
  var xy = R({}, _a, {
    ...
    Vy = Ql(Cy),
    Ly = R({}, Su, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
    Ky = Ql(Ly),
    Jy = R({}, Ne, {
      deltaX: function (l) {
        return "deltaX" in l
  ...
  function at(l, t) {
    if (typeof l == "object" && l !== null) {
      ...
      return u !== void 0
        ? u
        : ((t = { value: l, source: t, stack: Si(t) }), l0.set(l, t), t);
    }
  ...
  function qa(l) {
    ...
    if (
      ...
      t === 27
        ...
        : (vl = pl ? ot(l.stateNode.nextSibling) : null);
    return !0;
  }
  function Ya() {
    ((vl = pl = null), (W = !1));
  ...
  function Ca(l, t, u, a) {
    ...
    if (c !== null) {
      ...
      r !== null &&
        ...
        (c = r.lastBaseUpdate),
        c !== f &&
          (c === null ? (r.firstBaseUpdate = h) : (c.next = h),
          (r.lastBaseUpdate = i)));
    }
    if (n !== null) {
      var T = e.baseState;
  ...
  function Zf(l, t, u) {
    ...
    if (((n = l.baseState), e === null)) l.memoizedState = n;
      ...
      if (
        (i === null ? (f = n) : (i.next = c),
        !Wl(n, l.memoizedState) && ((Tl = !0), r && ((u = Iu), u !== null)))
      )
        throw u;
      ((l.memoizedState = n),
        (l.baseState = f),
      ...
      if (u !== null) {
        l: {
          ...
          if (W) {
            if (vl) {
              t: {
                for (var e = vl, n = rt; e.nodeType !== 8; ) {
                  if (!n) {
                    e = null;
                    break t;
                  }
              ...
              if (e) {
                ((vl = ot(e.nextSibling)), (a = e.data === "F!"));
                break l;
              }
            }
            zu(a);
  ...
  function p0(l, t, u) {
    ...
    return (
      u !== t.memoizedState &&
        ((Q.flags |= 2048), ua(9, $e(), T1.bind(null, e, u), null)),
      [a, n, l]
    );
  }
  function T1(l, t) {
    ...
    ts = {
      ...
      useSyncExternalStore: function (l, t, u) {
        ...
        if (W) {
          ...
          if (((u = t()), el === null)) throw Error(S(349));
          (V & 124) !== 0 || A0(a, t, u);
        }
        e.memoizedState = u;
      ...
      useCacheRefresh: function () {
        return (xl().memoizedState = A1.bind(null, Q));
      },
    },
    us = {
      readContext: Hl,
  ...
  function es(l) {
    ...
    function i(y, v, d, b) {
      var M = d.type;
      return M === Bl
        ? r(y, v, d.props.children, b, d.key)
        : v !== null &&
            (v.elementType === M ||
              (typeof M == "object" &&
                M !== null &&
    ...
    function o(y, v, d, b) {
      ...
      if (typeof d == "object" && d !== null) {
        ...
        if (Ul(d) || Dl(d)) return M !== null ? null : r(y, v, d, b, null);
    ...
    function m(y, v, d, b, M) {
      ...
      if (typeof b == "object" && b !== null) {
        ...
        if (Ul(b) || Dl(b))
          return ((y = y.get(d) || null), r(v, y, b, M, null));
    ...
    if (
      ...
      if (
        ...
        switch (u.tag) {
          case 13:
            return (
              gt === null ? Ec() : u.alternate === null && yl === 0 && (yl = 3),
              (u.flags &= -257),
              (u.flags |= 65536),
              (u.lanes = e),
              a === Mf
      ...
      return (
        ...
        t !== null
          ? ((t.flags & 65536) === 0 && (t.flags |= 256),
            (t.flags |= 65536),
            (t.lanes = e),
            a !== bf && ((l = Error(S(422), { cause: a })), Ba(at(l, u))))
          : (a !== bf && ((t = Error(S(423), { cause: a })), Ba(at(t, u))),
  ...
  function Ss(l, t, u, a, e) {
    ...
    return (
      ...
      l !== null && !Tl
        ? (Gf(l, t, e), Yt(l, t, e))
        : (W && c && rf(t), (t.flags |= 1), zl(l, t, a, e), t.child)
    );
  }
  ...
  function If(l, t, u, a, e) {
    return (
      ...
      l !== null && !Tl
        ? (Gf(l, t, e), Yt(l, t, e))
        : (W && a && rf(t), (t.flags |= 1), zl(l, t, u, e), t.child)
    );
  }
  function Es(l, t, u, a, e, n) {
    return (
      ...
      l !== null && !Tl
        ? (Gf(l, t, n), Yt(l, t, n))
        : (W && a && rf(t), (t.flags |= 1), zl(l, t, u, n), t.child)
    );
  }
  ...
  function Ds(l, t, u) {
    if (l !== null)
      if (l.memoizedProps !== t.pendingProps) Tl = !0;
        ...
        if (!nc(l, u) && (t.flags & 128) === 0) return ((Tl = !1), M1(l, t, u));
        Tl = (l.flags & 131072) !== 0;
      }
        ...
        l: {
          ...
          if (
            ...
            if (
              ...
              ((e = at(Error(S(424)), t)), Ba(e), (t = zs(l, t, a, u)));
              break l;
            } else {
      ...
      case 27:
        return (
          ...
          l === null &&
            ...
            (rt = !0),
            (e = vl),
            nu(t.type) ? ((xc = e), (vl = ot(a.firstChild))) : (vl = e)),
      ...
      case 5:
        return (
          l === null &&
            W &&
            ((e = a = vl) &&
              ((a = ld(a, t.type, t.pendingProps, rt)),
              a !== null
                ? ((t.stateNode = a),
                  (pl = t),
                  (vl = ot(a.firstChild)),
          ...
          t.memoizedState !== null &&
            ((e = Bf(l, t, g1, null, null, u)), (ve._currentValue = e)),
          en(l, t),
          zl(l, t, a, u),
          t.child
        );
    ...
    switch ((gf(t), t.tag)) {
      ...
      case 26:
        return (
          ...
          l === null
            ? (Bt(t),
              u !== null ? (sl(t), Us(t, u)) : (sl(t), (t.flags &= -16777217)))
            : u
              ? u !== l.memoizedState
                ? (Bt(t), sl(t), Us(t, u))
      ...
      case 4:
        return (Zt(), l === null && Hc(t.stateNode.containerInfo), sl(t), null);
      case 10:
        return (Ht(t.type), sl(t), null);
      case 19:
        if ((_(gl), (e = t.memoizedState), e === null)) return (sl(t), null);
  ...
  function Qs(l, t, u) {
    ...
    switch (u.tag) {
      ...
      case 14:
      case 15:
        (ol || Ft(2, u, t), ol || Ft(4, u, t), Gt(l, t, u));
        break;
      case 1:
        (ol ||
          (bt(u, t),
  ...
  function lt(l, t, u) {
    (((l === el && (k === 2 || k === 9)) || l.cancelPendingCommit !== null) &&
      ...
      Ta(l, u),
      (($ & 2) === 0 || l !== el) &&
        (l === el && (($ & 2) === 0 && (Hu |= u), yl === 4 && eu(l, V, it, !1)),
        Et(l)));
  }
  function $s(l, t, u) {
      ...
      if (e === 0) {
        ...
        l: {
          ...
          if ((t & 62914560) === t && ((e = Sc + 300 - St()), 10 < e)) {
            if ((eu(a, t, it, !lu), Ee(a, 0, !0) !== 0)) break l;
            a.timeoutHandle = Ov(
              ks.bind(null, a, u, jl, yn, mc, t, it, Hu, ia, lu, n, 2, -0, 0),
              e,
            );
            break l;
          }
          ks(a, u, jl, yn, mc, t, it, Hu, ia, lu, n, 0, -0, 0);
        }
      }
      break;
    } while (!0);
  ...
  function ks(l, t, u, a, e, n, f, c, i, h, r, T, o, m) {
    if (
      ...
      (T & 8192 || (T & 16785408) === 16785408) &&
        ((se = { stylesheets: null, count: 0, unsuspend: od }),
        Vs(t),
        (T = Sd()),
        T !== null))
    ) {
      ((l.cancelPendingCommit = T(
        av.bind(null, l, t, n, u, a, e, f, c, i, r, 1, o, m),
      )),
        eu(l, n, f, !h));
      return;
    }
          ...
          : (k =
              t === ms
                ...
                : t !== null &&
                  ...
                  : 1),
      (Il = t),
      j === null && ((yl = 1), an(l, at(t, l.current))));
  }
  function Is() {
    var l = g.H;
  ...
  function Ec() {
    ((yl = 4),
      lu || ((V & 4194048) !== V && ct.current !== null) || (ca = !0),
  ...
  function da(l, t, u, a) {
    ...
    try {
      if (_1(l, e, t, u, V)) {
        ((yl = 1), an(l, at(u, l.current)), (j = null));
        return;
      }
    } catch (n) {
  ...
  function zc(l, t, u) {
    ...
    e.has(u) ||
      ((hc = !0), e.add(u), (l = X1.bind(null, l, t, u)), t.then(l, l));
  }
  function X1(l, t, u) {
    var a = l.pingCache;
    (a !== null && a.delete(t),
      ...
      el === l &&
        (V & u) === u &&
        (yl === 4 || (yl === 3 && (V & 62914560) === V && 300 > St() - Sc)
          ? ($ & 2) === 0 && ya(l, 0)
          : (oc |= u),
        ia === V && (ia = 0)),
      Et(l));
  ...
  for (var Dc = 0; Dc < yf.length; Dc++) {
    var Uc = yf[Dc],
      L1 = Uc.toLowerCase(),
      K1 = Uc[0].toUpperCase() + Uc.slice(1);
    dt(L1, "on" + K1);
  }
  (dt($i, "onAnimationEnd"),
    ...
    _i(function () {
      ...
      l: {
        ...
        if (o !== void 0) {
          ...
          0 < q.length &&
            ((o = new m(o, p, null, u, r)), T.push({ event: o, listeners: q }));
        }
      }
      if ((t & 7) === 0) {
        l: {
          ...
          if (
            ...
            if (
              ...
              (ll = m == null ? o : Aa(m)),
              (d = p == null ? o : Aa(p)),
              (o = new q(b, v + "leave", m, u, r)),
              (o.target = ll),
              (o.relatedTarget = d),
              (b = null),
              Bu(r) === h &&
                ((q = new q(y, v + "enter", p, u, r)),
                (q.target = d),
                (q.relatedTarget = ll),
                (b = q)),
              (ll = b),
...
`,
    ...
    switch (t) {
      ...
      default:
        if (wn(t)) {
          for (r in u)
            u.hasOwnProperty(r) &&
              ((a = u[r]), a !== void 0 && qc(l, t, r, a, u, void 0));
          return;
        }
    }
    for (c in u)
  ...
  var Ov = typeof setTimeout == "function" ? setTimeout : void 0,
    ...
    I1 =
      typeof queueMicrotask == "function"
        ...
        : typeof _v < "u"
          ? function (l) {
              return _v.resolve(null).then(l).catch(P1);
            }
          : Ov;
  function P1(l) {
    setTimeout(function () {
  ...
  var wv = il.version;
  if (wv !== "19.1.1") throw Error(S(527, wv, "19.1.1"));
...
function pd() {
  ...
  return (D(), (Fc.exports = Bd()), Fc.exports);
}
var Gd = pd();
function Xd() {
  const D = (il) => {
    (il.preventDefault(), console.log("good"));
  };
  return xt.jsxs(xt.Fragment, {
    children: [
      xt.jsx("h1", { children: "ふりかえり" }),
      xt.jsxs("form", {
        onSubmit: D,
        children: [
          xt.jsx("label", { htmlFor: "good", children: "良かったこと" }),
          xt.jsx("textarea", { id: "good", name: "good" }),
          xt.jsx("button", { type: "submit", children: "保存" }),
        ],
      }),
    ],
  });
...
Gd.createRoot(document.getElementById("root")).render(
  xt.jsx(Rd.StrictMode, { children: xt.jsx(Xd, {}) }),
);
